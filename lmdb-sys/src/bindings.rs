...
pub const MDB_VERSION_MAJOR: ::libc::c_uint = 1;
pub const MDB_VERSION_MINOR: ::libc::c_uint = 0;
pub const MDB_VERSION_PATCH: ::libc::c_uint = 0;
pub const MDB_VERSION_DATE: &[u8; 15] = b"April 28, 2026\0";
...
pub const MDB_TXN_PENDING: ::libc::c_int = -30775;
pub const MDB_CANT_ROLLBACK: ::libc::c_int = -30774;
pub const MDB_DBIS_BUSY: ::libc::c_int = -30773;
pub const MDB_SHORT_WRITE: ::libc::c_int = -30772;
pub const MDB_ENV_BUSY: ::libc::c_int = -30771;
pub const MDB_IS_READONLY: ::libc::c_int = -30770;
pub const MDB_ADDR_BUSY: ::libc::c_int = -30769;
pub const MDB_LAST_ERRCODE: ::libc::c_int = -30769;
...
unsafe extern "C" {
    #[doc = "Perform incremental dump of an LMDB environment to the\n\tspecified file descriptor.\n\n This function may be used to make an incremental backup of an\n existing environment.\n > **Note:** This call can trigger significant file size growth if run in\n parallel with write transactions, because it employs a read-only\n transaction. See long-lived transactions under caveats_sec.\n # Arguments\n\n* `env` (direction in) - An environment handle returned by #mdb_env_create(). It\n must have already been opened successfully.\n * `fd` (direction in) - The filedescriptor to write the copy to. It must\n have already been opened for Write access.\n * `txnid` (direction in) - The transaction ID of a previous backup. It must\n be greater than zero.\n # Returns\n\nA non-zero error value on failure and 0 on success."]
    pub fn mdb_env_incr_dumpfd(
        env: *mut MDB_env,
        fd: mdb_filehandle_t,
        txnid: usize,
    ) -> ::libc::c_int;
...
unsafe extern "C" {
    #[doc = "Perform incremental dump of an LMDB environment to the\n\tspecified file.\n\n This function may be used to make an incremental backup of an\n existing environment.\n > **Note:** This call can trigger significant file size growth if run in\n parallel with write transactions, because it employs a read-only\n transaction. See long-lived transactions under caveats_sec.\n # Arguments\n\n* `env` (direction in) - An environment handle returned by #mdb_env_create(). It\n must have already been opened successfully.\n * `path` (direction in) - The name of the file to write the copy to. It must\n not already exist.\n * `txnid` (direction in) - The transaction ID of a previous backup. It must\n be greater than zero.\n # Returns\n\nA non-zero error value on failure and 0 on success."]
    pub fn mdb_env_incr_dump(
        env: *mut MDB_env,
        path: *const ::libc::c_char,
        txnid: usize,
    ) -> ::libc::c_int;
...
unsafe extern "C" {
    #[doc = "Reload an incremental dump of an LMDB environment from the\n\tspecified file descriptor.\n\n This function may be used to load an incremental backup of an\n existing environment.\n > **Note:** No other tasks may access the environment while this runs.\n # Arguments\n\n* `env` (direction in) - An environment handle returned by #mdb_env_create(). It\n must have already been opened successfully, using #MDB_WRITEMAP.\n * `fd` (direction in) - The filedescriptor to read the backup from.\n # Returns\n\nA non-zero error value on failure and 0 on success."]
    pub fn mdb_env_incr_loadfd(env: *mut MDB_env, fd: mdb_filehandle_t) -> ::libc::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    #[doc = "Retrieve the transaction's flags\n\n # Arguments\n\n* `txn` (direction in) - A transaction handle returned by #mdb_txn_begin()\n * `flags` (direction out) - Address where the flags will be returned.\n # Returns\n\nA non-zero error value on failure and 0 on success."]
    pub fn mdb_txn_flags(txn: *mut MDB_txn, flags: *mut ::libc::c_uint) -> ::libc::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    #[doc = "Load a dynamically loadable module.\n\n # Arguments\n\n* `file` (direction in) - The pathname of the module to load.\n * `symname` (direction in) - The name of a symbol to resolve in the module.\n * `mcf_ptr` (direction out) - The crypto hooks returned from the module.\n * `errmsg` (direction out) - Messages for any errors from trying to load the module.\n # Returns\n\nThe handle to the loadable module that can be unloaded by #mdb_modunload(),\n or NULL if loading failed."]
    pub fn mdb_modload(
        file: *const ::libc::c_char,
        symname: *const ::libc::c_char,
        mcf_ptr: *mut *mut MDB_crypto_funcs,
        errmsg: *mut *mut ::libc::c_char,
    ) -> *mut ::libc::c_void;
}
unsafe extern "C" {
    #[doc = "Unload a dynamically loaded module.\n\n All environments that used the functions in the module must be closed\n before unloading the module.\n # Arguments\n\n* `handle` (direction in) - The handle returned by #mdb_modload()."]
    pub fn mdb_modunload(handle: *mut ::libc::c_void);
}
unsafe extern "C" {
    #[doc = "Set an environment to use the given crypto functions.\n\n This is just a wrapper around #mdb_env_set_encrypt() to ease use of\n dynamically loaded crypto functions.\n # Arguments\n\n* `env` (direction in) - An environment handle returned by #mdb_env_create()\n * `mcf_ptr` (direction in) - The crypto hooks retrieved by #mdb_modload().\n * `passphrase` (direction in) - The secret used to generate the encryption key for the environment."]
    pub fn mdb_modsetup(
        env: *mut MDB_env,
        mcf_ptr: *mut MDB_crypto_funcs,
